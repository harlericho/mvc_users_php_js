...
<body>
  <div class="container">
    <div class="row p-5">
      <div class="col-sm-4">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title"> <img src="../../assets/images/form.png" alt="formualrio" class="iconoformulario"> Formulario</h5>
      ...
      <div class="col-sm-8">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title"> <img src="../../assets/images/list.png" alt="listado" class="iconolistado"> Listado</h5>
            <div class="table table-responsive">
              <table class="table">
                ...
                <tfoot class="table-light">
                  <tr>
                    <td colspan="5">Total de registros: <span id="total"></span> </td>
                  </tr>
                </tfoot>
              </table>
            </div>
    ...
    <footer class="footer">
      <p class="text-center">@harlericho</p>
    </footer>
  </div>
  ...
  <script type="module" src="../../assets/js/AppAsset.js"></script>
</body>
